...
public class Level2Controller : MonoBehaviour
{
    ...
    public GameObject SoundsExercise;
    ...
    private void Start()
    {
        ...
        /* Events */
        SoundsExercise SoundsExerciseComponent = SoundsExercise.GetComponent<SoundsExercise>();
        ...
        SoundsExerciseComponent.OnError += StartErrorCinematic;
        SoundsExerciseComponent.OnWin += StartWinCinematic;
    ...
    public IEnumerator Level1Cinematic1()
    {
        ...
        lvlConnieHelperButton.gameObject.SetActive(false); blackOverlay.SetActive(false); SoundsExercise.SetActive(false);
    ...
    {
        yield return new WaitForSeconds(0.8f); blackOverlay.SetActive(true); SoundsExercise.SetActive(true);
    ...
    public IEnumerator Level01ErrorAction()
    {
        ...
        blackOverlay.GetComponent<Animator>().SetInteger("state", 1); SoundsExercise.GetComponent<Animator>().SetInteger("state", 1);
