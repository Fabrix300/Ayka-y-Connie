...
public class Level4Controller : MonoBehaviour
{
    ...
    public GameObject addingExercise;
    ...
    private void Start()
    {
        ...
        /* Events */
        AddingExercise addingExerciseComponent = addingExercise.GetComponent<AddingExercise>();
        ...
        addingExerciseComponent.OnError += StartErrorCinematic;
        addingExerciseComponent.OnWin += StartWinCinematic;
    ...
    public IEnumerator Level1Cinematic1()
    {
        ...
        lvlConnieHelperButton.gameObject.SetActive(false); blackOverlay.SetActive(false); addingExercise.SetActive(false);
    ...
    {
        yield return new WaitForSeconds(0.8f); blackOverlay.SetActive(true); addingExercise.SetActive(true);
    ...
    public IEnumerator Level01ErrorAction()
    {
        ...
        blackOverlay.GetComponent<Animator>().SetInteger("state", 1); addingExercise.GetComponent<Animator>().SetInteger("state", 1);
